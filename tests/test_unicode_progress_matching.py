...
class TestUnicodeProgressMatching:
    ...
    def test_progress_matching_no_match_different_content(self, qapp):
        ...
        cloudcast = Cloudcast(
            name="Mix A", url="https://www.mixcloud.com/testuser/mix-a/", user=user
        )
    ...
    def test_unicode_character_replacements(self, qapp):
        ...
        for input_name, expected_output in test_cases:
            ...
            cloudcast = Cloudcast(
                name=input_name, url="https://www.mixcloud.com/user/test/", user=user
            )
    ...
    def test_big_solidus_progress_matching(self, qapp):
        ...
        expected_result = (
            "rogersmorgan - david ferrer & roger s morgan live set rincon de tintin 280821"
        )
        assert expected_normalized == expected_result

        # Simulate yt-dlp providing the exact normalized filename (realistic scenario)
        ytdlp_filename = (
            "rogersmorgan - david ferrer & roger s morgan live set rincon de tintin 280821.m4a"
        )
    ...
    def test_comprehensive_unicode_normalization(self, qapp):
        ...
        test_cases = [
            ...
            (
                ...
                "testuser - mix:with*specialchars",
            ),  # : and * preserved, / removed
        ...
        for input_name, expected_base in test_cases:
            cloudcast = Cloudcast(
                name=input_name, url="https://www.mixcloud.com/testuser/test/", user=user
            )
    ...
    def test_full_width_characters_progress_matching(self, qapp):
        ...
        ytdlp_filename = (
            "PrettyLights - ep299 ft. Zoogma ：： Pretty Lights - The HOT Sh＊t - 10.04.17.m4a"
        )
    ...
    def test_file_extension_handling_with_dots_in_names(self, qapp):
        ...
        test_cases = [
            ...
            (
                "PrettyLights - ep299 ft. Zoogma :: Pretty Lights - The HOT Sh*t - 10.04.17.mp3",
                True,
            ),
            (
                "PrettyLights - ep299 ft. Zoogma :: Pretty Lights - The HOT Sh*t - 10.04.17.flac",
                True,
            ),
            ...
            (
                "PrettyLights - ep299 ft. Zoogma :: Pretty Lights - The HOT Sh*t - 10.04.17.txt",
                False,
            ),
            (
                "PrettyLights - ep299 ft. Zoogma :: Pretty Lights - The HOT Sh*t - 10.04.17.pdf",
                False,
            ),
            # Same date format should work
            (
                "PrettyLights - ep299 ft. Zoogma :: Pretty Lights - The HOT Sh*t - 10.04.17.wav",
                True,
            ),
        ]
    ...
    def test_known_audio_extensions_list(self, qapp):
        ...
        for audio_format in AUDIO_FORMATS.values():
            ...
            ), f"Extension {audio_format.extension} was not properly stripped"
