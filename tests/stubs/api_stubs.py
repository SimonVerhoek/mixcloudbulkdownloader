...
class FakeHTTPClient:
    ...
    def __init__(self) -> None:
        ...
        self.responses: dict[str, dict[str, Any]] = {
            ...
            "cloudcasts_page1": {
                "data": [
                    {"name": "Test Mix 1", "url": "https://www.mixcloud.com/testuser/test-mix-1/"},
                    {"name": "Test Mix 2", "url": "https://www.mixcloud.com/testuser/test-mix-2/"},
                ],
                "paging": {"next": "https://api.mixcloud.com/testuser/cloudcasts/?offset=20"},
            },
            "cloudcasts_page2": {
                "data": [
            ...
            "api_error": {"error": {"type": "InvalidRequest", "message": "Invalid search query"}},
        }
